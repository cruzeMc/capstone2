...
def update_event():
    ...
    event = Event.query.filter_by(id=idnum).first()
    form = UpdateForm()
    form_action = url_for('update_event')
        for 
        query = Event(user_id, form.category.data, filename, form.eventname.data, form.date.data, form.start_time.data, form.end_time.data, form.venue.data, form.lat.data, form.lng.data, form.capacity.data, form.admission.data, form.description.data, form.contact.data)

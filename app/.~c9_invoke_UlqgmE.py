...
def signup():
    ...
    if request.method=='POST':
        img=form.poster.data
        filename=secure_filename(img.filename)
        form.poster.data.save(os.path.join('app/static/profile_pics',filename))
        # user=Users(filename,form.first_name.data,form.last_name.data,form.username.data,form.password.data,form.email.data,form.address.data)
        db.session.add(user)
        db.session.commit()
#     user = Users(request.form['first_name'], request.form['last_name'], request.form['usersname'], PI, request.form['email'], request.form['address'], request.form['sex'], request.form['age'])
    return redirect(url_for('login'))
...
#     # user = Users(request.form['password'], request.form['first_name'], request.form['last_name'] ,request.form['username'], request.form['email'], request.form['address'])
    
#     user = Users(request.form['first_name'], request.form['last_name'], request.form['usersname'], PIC HERE, request.form['email'], request.form['address'], request.form['sex'], request.form['age'], request.form['password'])
